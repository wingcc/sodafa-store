    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          >
            <Shield className="w-8 h-8" style={{ color: 'var(--color-darkGreen)' }} />
          </div>
          <h1 className="text-3xl font-bold" style={{ color: 'var(--color-cream)' }}>Welcome Back</h1>
          <p className="mt-2" style={{ color: 'var(--color-warmCream)' }}>Sign in to your account to continue</p>
        </div>
        ...
        >
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="block text-sm font-medium" style={{ color: 'var(--color-cream)' }}>
                  Password
                </label>
                <Link
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                style={{ background: rememberMe ? 'var(--color-gold)' : 'transparent' }}
              >
                {rememberMe && <span className="text-xs" style={{ color: 'var(--color-gold)' }}>✓</span>}
              </button>
              <span className="text-sm" style={{ color: 'var(--color-warmCream)' }}>Remember me</span>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-4" style={{ color: 'var(--color-warmCream)' }}>Don`&apos;`t have an account?</span>
            </div>
          </div>
