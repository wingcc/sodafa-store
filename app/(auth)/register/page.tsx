      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div>
              <label htmlFor="name" className="block text-sm font-medium mb-1.5" style={{ color: '#f5f0e6' }}>
                Full Name
              </label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: '#e8dfc8' }} />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium mb-1.5" style={{ color: '#f5f0e6' }}>
                Password
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium mb-1.5" style={{ color: '#f5f0e6' }}>
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: '#e8dfc8' }} />
            ...
            {password.length > 0 && (
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs whitespace-nowrap" style={{ color: '#e8dfc8' }}>
            ...
            <div className="flex items-start gap-3 pt-1">
              <button
                ...
                style={{ background: agreeToTerms ? '#cda552' : 'transparent' }}
              >
                {agreeToTerms && <span className="text-xs" style={{ color: '#061c16' }}>✓</span>}
              </button>
              <span className="text-sm" style={{ color: '#e8dfc8' }}>
                I agree to the{' '}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-4" style={{ color: '#e8dfc8' }}>Already have an account?</span>
            </div>
          </div>
