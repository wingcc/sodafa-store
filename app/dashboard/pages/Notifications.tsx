    ...
    <div className="space-y-6 p-4 md:p-6 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl text-sm font-medium border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 transition flex items-center gap-2"
          >
            <CheckCheck size={16} />
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="px-4 py-2 rounded-xl text-sm font-medium bg-blue-500 text-white hover:bg-blue-600 transition flex items-center gap-2 shadow-sm shadow-blue-200"
            >
              <Check size={16} />
              Mark all read
            </button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
          ...
          <p className="text-2xl font-bold text-slate-800 mt-1">{notifications.length}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
          <div className="flex items-center justify-between">
        ...
        <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">Bookmarks</span>
            <Star size={16} className="text-amber-500" />
          </div>
          <p className="text-2xl font-bold text-slate-800 mt-1">{bookmarkedIds.size}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">Urgent</span>
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-xl text-sm border border-slate-200 bg-slate-50 text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
            >
        ...
        {selectMode && (
          <div className="flex items-center gap-3 mt-3 pt-3 border-t border-slate-100">
            <button
              ...
              className="text-sm text-slate-600 hover:text-blue-600 transition flex items-center gap-1"
            >
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl border shadow-sm transition-all hover:shadow-md ${
                  !notification.read ? 'border-blue-200 bg-blue-50/30' : 'border-slate-200/60'
                    ...
                    <div className="flex flex-wrap items-start gap-2">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <h4 className={`text-sm font-semibold ${!notification.read ? 'text-slate-800' : 'text-slate-600'}`}>
                            {notification.title}
                          </h4>
                          <Badge variant="outline" size="sm" className={`border ${priorityColor}`}>
                        ...
                        <p className={`text-sm mt-0.5 ${!notification.read ? 'text-slate-700' : 'text-slate-500'}`}>
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition ${
                            isBookmarked ? 'text-amber-500 hover:bg-amber-50' : 'text-slate-400 hover:bg-slate-100'
                          }`}
                  ...
                  <div className="px-4 pb-4 pt-1 border-t border-slate-100 mt-1">
                    <div className="bg-slate-50 rounded-xl p-4 space-y-2">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-slate-600">Full message:</span>
                      </div>
                      <p className="text-sm text-slate-700">{notification.message}</p>
                      {notification.metadata && Object.keys(notification.metadata).length > 0 && (
                        <div className="mt-2 pt-2 border-t border-slate-200">
                          <p className="text-xs font-medium text-slate-500 mb-1">Metadata</p>
                          <pre className="text-xs bg-white p-2 rounded-lg border border-slate-200 text-slate-600 overflow-x-auto">
      ...
      {filteredNotifications.length > 0 && (
        <div className="text-center pt-4">
          <button className="px-6 py-2 rounded-xl text-sm font-medium border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 transition">
            Load more
          </button>
        </div>
      )}
...
const NotificationsLoadingPage: React.FC = () => {
  return (
    <div className="space-y-6 p-4 md:p-6 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 min-h-screen">
      ...
      <div className="space-y-3">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="bg-white rounded-2xl border border-slate-200/60 p-4">
