...
export const dashboardRegistry: WidgetMeta[] = [
  ...
  { id: 'revenue-overview', name: 'Revenue Overview', nameAr: 'نظرة الإيرادات', description: 'Daily revenue & orders trend', descriptionAr: 'اتجاه الإيرادات والطلبات اليومية', category: 'Revenue', defaultVisible: true, defaultColSpan: 9, defaultRowSpan: 2, minColSpan: 6, maxColSpan: 12, minRowSpan: 1, maxRowSpan: 4 },
  ...
  { id: 'cod-performance', name: 'COD Performance', nameAr: 'أداء الدفع عند الاستلام', description: 'Confirmation, delivery, RTO rates', descriptionAr: 'معدلات التأكيد والتسليم والإرجاع', category: 'Operations', defaultVisible: true, defaultColSpan: 6, defaultRowSpan: 2, minColSpan: 6, maxColSpan: 12, minRowSpan: 1, maxRowSpan: 4 },
  ...
  { id: 'recent-orders', name: 'Recent Orders', nameAr: 'الطلبات الأخيرة', description: 'Latest 5 orders', descriptionAr: 'آخر 5 طلبات', category: 'Orders', defaultVisible: true, defaultColSpan: 9, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 12, minRowSpan: 1, maxRowSpan: 4 },
...
export const analyticsRegistry: WidgetMeta[] = [
  ...
  { id: 'visitor-trends', name: 'Visitor Trends', nameAr: 'اتجاهات الزوار', description: 'Visitors/sessions/views over time', descriptionAr: 'الزوار والجلسات عبر الزمن', category: 'Visitors', defaultVisible: true, defaultColSpan: 9, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 12, minRowSpan: 2, maxRowSpan: 4 },
  { id: 'conversion-funnel', name: 'Conversion Funnel', nameAr: 'مسار التحويل', description: 'Visitors → Delivered', descriptionAr: 'من الزوار حتى التسليم', category: 'Conversion', defaultVisible: true, defaultColSpan: 6, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 9, minRowSpan: 2, maxRowSpan: 4 },
  ...
  { id: 'traffic-performance', name: 'Traffic Performance', nameAr: 'أداء المصادر', description: 'Sessions by source', descriptionAr: 'الجلسات حسب المصدر', category: 'Acquisition', defaultVisible: true, defaultColSpan: 8, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 12, minRowSpan: 2, maxRowSpan: 4 },
  ...
  { id: 'product-analytics', name: 'Product Analytics', nameAr: 'تحليل المنتجات', description: 'Views, ATC, orders per product', descriptionAr: 'المشاهدات والسلة والطلبات لكل منتج', category: 'Product', defaultVisible: true, defaultColSpan: 12, defaultRowSpan: 4, minColSpan: 9, maxColSpan: 12, minRowSpan: 2, maxRowSpan: 4 },
  ...
  { id: 'geographic-analytics', name: 'Geographic Analytics', nameAr: 'التحليل الجغرافي', description: 'Country & city performance', descriptionAr: 'أداء الدول والمدن', category: 'Geography', defaultVisible: true, defaultColSpan: 6, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 12, minRowSpan: 2, maxRowSpan: 4 },
  { id: 'top-pages', name: 'Top Pages', nameAr: 'أهم الصفحات', description: 'Most visited pages with share', descriptionAr: 'الصفحات الأكثر زيارة', category: 'Content', defaultVisible: true, defaultColSpan: 6, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 12, minRowSpan: 2, maxRowSpan: 4 },
  ...
  { id: 'peak-hours', name: 'Peak Hours', nameAr: 'ساعات الذروة', description: 'Heatmap by day/hour', descriptionAr: 'خريطة حرارية حسب اليوم والساعة', category: 'Time', defaultVisible: true, defaultColSpan: 9, defaultRowSpan: 3, minColSpan: 6, maxColSpan: 12, minRowSpan: 2, maxRowSpan: 4 },
