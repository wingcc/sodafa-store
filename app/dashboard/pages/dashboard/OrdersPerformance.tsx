...
import { ShoppingCart, CheckCircle2, Clock3, XCircle, RotateCcw, TrendingUp, TrendingDown } from 'lucide-react';
import { useTranslation } from '../../i18n/useTranslation';
import DashboardInfoButton from './DashboardInfoButton';
import { getOrderStatusCounts, getSparklineData, sparklinePath, buildOrdersSparkline } from './utils';
import type { Order } from '../../types';

const OrdersPerformance: React.FC<{ orders: Order[] }> = ({ orders }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-white/10 p-5">
      ...
      <div className="mt-3 flex gap-1.5 h-2 rounded-full overflow-hidden bg-gray-100 dark:bg-white/10">
        {items.map(it => (
