// app/(store)/content/[slug]/page.tsx
// Moved from app/content/[slug]/page.tsx to reuse Store chrome (Navbar/Footer/AnnouncementBar)
// Route remains /content/[slug] because (store) is a route group (does not affect URL)
...
export default async function StaticContentPage({ params }: PageProps) {
  ...
  return (
    <main className="flex-1 py-12 md:py-16 bg-stone-50">
