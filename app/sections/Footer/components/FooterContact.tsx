// sections/Footer/components/FooterContact.tsx
"use client";
  ...
  return (
    <div className="space-y-4">
        ...
        <li className="flex items-start gap-3 text-[15px]">
          ...
          <span style={{ color: COLORS.white }}>
            ...
            <a
              ...
              className="font-semibold transition-colors duration-200 hover:underline hover:brightness-110"
              style={{ color: COLORS.gold }}
            >
      ...
      >
        ...
        {locale === "ar" ? "تواصلي واتساب" : "Contact on WhatsApp"}
      </a>
    </div>
  );
};